            ...
            if st.button("Create Tasks from Selected Records"):
                ...
                for idx, row in selected_rows.iterrows():
                    ...
                    new_task = {
                        ...
                        "task_name": str(row[selected_column]),  # Initialize with the value
                        "status": "Not Started",
                        "planned_hours": 0,
                        "planned_minutes": 0,
                        "actual_hours": 0,
...
if st.session_state.tasks:
    ...
    # Filter options in a horizontal layout
    ...
    # Display each task as an editable card with consistent column layout
    for idx, task in filtered_tasks.iterrows():
        with st.container():
            ...
            with col1:
                ...
                # Task name dropdown from uploaded dataset
            ...
            with col2:
                # Status selection with consistent width
                ...
                # Planned time in a more compact layout
                ...
                # Actual time in a more compact layout
